...
import com.igeak.android.wearable.PutDataMapRequest;
import com.igeak.android.wearable.PutDataRequest;
...
public class DataFragment extends Fragment implements View.OnClickListener,
        GeakApiClient.ConnectionCallbacks, GeakApiClient.OnConnectionFailedListener {
    ...
    /**
     * Builds an {@link com.igeak.android.wearable.Asset} from a bitmap. The image that we get
    ...
    public void onStop() {
        if (!mResolvingError) {
            Wearable.DataApi.removeListener(mGeakApiClient, mDataListener);
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        Wearable.DataApi.addListener(mGeakApiClient, mDataListener);
    ...
    private void sendPhoto(Asset asset) {
        ...
        Wearable.DataApi.putDataItem(mGeakApiClient, request)
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.sendPhoto: {
                if (null != mImageBitmap && mGeakApiClient.isConnected()) {
